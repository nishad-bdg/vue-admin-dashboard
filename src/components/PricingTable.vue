...
.pricing-table {
  ...
  margin-top: 40px;
  background: var(--theme-background-price-table);
  width: 328.93px;
  height: 602.43px;
  ...
  padding-bottom: 20px;
  cursor: pointer;
  box-shadow: 1px 1px 10px 0px var(--theme-text-gray-600);
}
...
.table-header {
  ...
  width: 100%;
  padding: 20px;
  border-radius: 28.6px 28.6px 0px 0px;
  box-sizing: border-box;
}

.active .table-header h2 {
  font-size: 44.18px;
  font-weight: 700;
}
